...
import paho.mqtt.client as mqtt  # Paho is a Python library to get data from CV and UWB using MQTT protocol
import json  # json is data format to be used for differnt objects (javascript object notation)
from threading import Thread
from threading import Lock
from threading import Timer

from PIL import ImageTk  # put a picture (lab map) in the window
...
import demos.demo20220905.controller
...
# To control robots
robot_control = demos.demo20220905.controller.robot_controller(
...
def resize():
    ...
    tools.basewindow.canvas_map.delete(robot_control.canvas_tag)
    robot_control.draw_a()
    robot_control.draw_b()
